...
//         $Config['hook_tag'] = 'HTMLawedHookTag';
      ...
      $Spec = 'math=xmlns,display;semantics;annotation=encoding;mtable=rowspacing;object=-classid-type, -codebase; embed=type(oneof=application/x-shockwave-flash); a=class(noneof=Hijack|Dismiss|MorePager/nomatch=%pop[in|up|down]|flyout|ajax%i)';
